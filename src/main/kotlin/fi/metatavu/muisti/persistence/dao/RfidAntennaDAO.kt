...
class RfidAntennaDAO : AbstractDAO<RfidAntenna>() {
     ...
     */
    fun create(id: UUID, exhibition: Exhibition, deviceGroup: ExhibitionDeviceGroup?, room: ExhibitionRoom?, name: String, readerId: String, antennaNumber: Int, locationX: Double?, locationY: Double?, creatorId: UUID, lastModifierId: UUID): RfidAntenna {
