...
class DeviceModelTranslator :
    AbstractTranslator<fi.metatavu.muisti.persistence.model.DeviceModel, DeviceModel>() {

    override fun translate(entity: fi.metatavu.muisti.persistence.model.DeviceModel): DeviceModel {
