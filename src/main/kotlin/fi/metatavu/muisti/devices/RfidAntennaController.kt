...
class RfidAntennaController {
     ...
     */
    fun createRfidAntenna(exhibition: Exhibition, deviceGroup: ExhibitionDeviceGroup?, room: ExhibitionRoom?, name: String, readerId: String, antennaNumber: Int, location: Point, creatorId: UUID): RfidAntenna {
     ...
     * @return created rfidAntenna
     */
    fun updateRfidAntenna(rfidAntenna: RfidAntenna, deviceGroup: ExhibitionDeviceGroup?, room: ExhibitionRoom?, name: String, readerId: String, antennaNumber: Int, location: Point, modifierId: UUID): RfidAntenna {
