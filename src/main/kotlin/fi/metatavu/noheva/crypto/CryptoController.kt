package fi.metatavu.noheva.crypto
...
class CryptoController {
    ...
    fun loadPublicKey(key: ByteArray): PublicKey? {
        return try {
            ...
            logger.error("Error while loading public key from byte array")
            null
    ...
    /**
     * Verifies that given signature matches given UUID given public key
     *
     * @param publicKey public key
     * @param signature signature
     * @param id id
     * @return whether signature matched UUID with public key
     */
    ...
    /**
     * Verifies that given signature matches given data with given public key
     *
     * @param publicKey public key
     * @param signature signature
     * @param data data
