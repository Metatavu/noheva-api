 ...
 */
class ExhibitionContentVersionTestBuilderResource(testBuilder: AbstractTestBuilder<ApiClient?>?, val accessTokenProvider: AccessTokenProvider?, apiClient: ApiClient) : ApiTestBuilderResource<ExhibitionContentVersion, ApiClient?>(testBuilder, apiClient) {
    ...
    override fun getApi(): ExhibitionContentVersionsApi {
        ...
        return ExhibitionContentVersionsApi(TestSettings.apiBasePath)
    }
